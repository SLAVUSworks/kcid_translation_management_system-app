...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Register — {{ config('app.name', 'KCID TMS') }}</title>
            ...
            <div class="hidden lg:flex flex-col justify-between w-[480px] shrink-0 bg-[#0f1117] border-r border-[#1e2436] p-10 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h2 class="text-3xl font-extrabold leading-[1.15] tracking-[-0.025em] text-[#f1f2f6] mb-3">
                        Bergabung dengan<br><span class="text-[#f97316]">KCID</span> Translator
                    </h2>
                    <p class="text-sm leading-relaxed text-[#8892a4] max-w-[320px]">
                        Buat akun untuk mulai berkontribusi pada terjemahan Bahasa Indonesia KanColle bersama komunitas.
                    </p>
                </div>
                ...
                <div class="w-full max-w-[400px]">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-1.5">
                            <label for="name" class="text-[13px] font-medium text-[#8892a4] tracking-[0.01em]">
                                Full name
                            </label>
                            <input
                                id="name"
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div class="flex flex-col gap-1.5">
                                ...
                                >
                                @error('password')
                                    <p class="flex items-start gap-1.5 text-xs text-red-400 mt-0.5">
                                        <svg class="w-3 h-3 shrink-0 mt-px" viewBox="0 0 12 12" fill="none">
                                            <circle cx="6" cy="6" r="5.5" stroke="currentColor" stroke-opacity="0.5"/>
                                            <path d="M6 4v2.5M6 8h.01" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
                                        </svg>
                                        {{ $message }}
                            ...
                            {{-- Confirm Password --}}
                            <div class="flex flex-col gap-1.5">
                                <label for="password_confirmation" class="text-[13px] font-medium text-[#8892a4] tracking-[0.01em]">
                                    Confirm
                                </label>
                                <input
