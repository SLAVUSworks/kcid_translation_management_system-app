...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Reset Password — {{ config('app.name', 'KCID TMS') }}</title>
        ...
        <div class="relative z-[1] min-h-screen flex">
            ...
            <div class="hidden lg:flex flex-col justify-between w-[480px] shrink-0 bg-[#0f1117] border-r border-[#1e2436] p-10 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h2 class="text-3xl font-extrabold leading-[1.15] tracking-[-0.025em] text-[#f1f2f6] mb-3">
                        Butuh bantuan<br>masuk ke <span class="text-[#f97316]">akun</span>?
                    </h2>
                    <p class="text-sm leading-relaxed text-[#8892a4] max-w-[320px]">
                        Admin kami siap membantu proses penggantian password. Hubungi kami melalui saluran yang tersedia.
                    </p>
                </div>
            ...
            <div class="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:px-16">
                ...
                <div class="w-full max-w-[400px]">
                    ...
                    {{-- Icon --}}
                    <div class="w-14 h-14 rounded-2xl bg-[rgba(249,115,22,0.12)] border border-[rgba(249,115,22,0.2)] flex items-center justify-center mb-6">
                        <svg class="w-6 h-6 text-[#f97316]" viewBox="0 0 24 24" fill="none">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2Zm0 11a1 1 0 0 1-1-1V8a1 1 0 1 1 2 0v4a1 1 0 0 1-1 1Zm1 4h-2v-2h2v2Z" fill="currentColor" opacity="0.2"/>
                    ...
                    {{-- Heading --}}
                    <h1 class="text-2xl font-extrabold tracking-[-0.025em] text-[#f1f2f6] mb-2">
                        Lupa password?
                    </h1>
                    <p class="text-sm text-[#8892a4] mb-8 leading-relaxed">
                        Reset password tidak dapat dilakukan secara mandiri. Hubungi admin untuk memproses penggantian password akun kamu.
                    </p>

                    {{-- Info card --}}
                    <div class="bg-[#181c27] border border-[#252a38] rounded-2xl p-5 mb-6 flex flex-col gap-4">

                        <p class="text-[13px] font-semibold text-[#f1f2f6]">Cara menghubungi admin:</p>

                        {{-- Step 1 --}}
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full bg-[rgba(249,115,22,0.12)] border border-[rgba(249,115,22,0.2)] flex items-center justify-center shrink-0 mt-px">
                                <span class="text-[10px] font-bold text-[#f97316]">1</span>
                            </div>
                            <div>
                                <p class="text-[13px] font-medium text-[#f1f2f6] mb-0.5">Siapkan informasi akunmu</p>
                                <p class="text-[12px] text-[#4e5668] leading-relaxed">Username atau email yang terdaftar di KCID TMS.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full bg-[rgba(249,115,22,0.12)] border border-[rgba(249,115,22,0.2)] flex items-center justify-center shrink-0 mt-px">
                                <span class="text-[10px] font-bold text-[#f97316]">2</span>
                            </div>
                            <div>
                                <p class="text-[13px] font-medium text-[#f1f2f6] mb-0.5">Hubungi admin via WhatsApp</p>
                                <p class="text-[12px] text-[#4e5668] leading-relaxed">Kirim pesan langsung ke nomor WhatsApp admin.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full bg-[rgba(249,115,22,0.12)] border border-[rgba(249,115,22,0.2)] flex items-center justify-center shrink-0 mt-px">
                                <span class="text-[10px] font-bold text-[#f97316]">3</span>
                            </div>
                            <div>
                                <p class="text-[13px] font-medium text-[#f1f2f6] mb-0.5">Tunggu konfirmasi</p>
                                <p class="text-[12px] text-[#4e5668] leading-relaxed">Admin akan memproses dan mengirimkan password baru kepadamu.</p>
                            </div>
                        </div>
                    </div>

                    {{-- WhatsApp CTA --}}
                    <a href="https://wa.me/6282392797234"
                       target="_blank"
                       class="btn-glow w-full flex items-center justify-center gap-2 px-6 py-2.5 bg-[#f97316] text-white text-sm font-semibold rounded-[10px] no-underline transition-all duration-150 hover:bg-[#ea6c0f] hover:-translate-y-px active:translate-y-0 mb-3">
