                ...
                <div class="p-5 flex flex-col gap-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div class="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-3">
                            <p class="text-[0.6rem] sm:text-[0.62rem] font-bold uppercase tracking-[0.08em] sm:tracking-[0.12em] text-emerald-400 break-words">
                                Translated
                            </p>
                        ...
                        <div class="rounded-xl border border-orange-500/20 bg-orange-500/5 p-3">
                            <p class="text-[0.6rem] sm:text-[0.62rem] font-bold uppercase tracking-[0.08em] sm:tracking-[0.12em] text-orange-400 break-words">
                                Progress
                            </p>
                        ...
                        <div class="rounded-xl border border-red-500/20 bg-red-500/5 p-3">
                            <p class="text-[0.6rem] sm:text-[0.62rem] font-bold uppercase tracking-[0.08em] sm:tracking-[0.12em] text-red-400 break-words">
                                Untranslated
                            </p>
