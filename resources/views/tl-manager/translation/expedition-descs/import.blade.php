...
@section('title', 'Import Expedition Descriptions')
...
<div class="flex flex-col gap-6">
    ...
    <div class="flex items-end justify-between flex-wrap gap-4">
        <div>
            ...
            <h1 class="text-slate-100 tracking-tight leading-tight mt-1.5">Import Expedition Descriptions</h1>
            ...
            <div class="bg-[#13161f] border border-[#1e2436] rounded-[0.85rem] overflow-hidden">
                ...
                <div class="p-[1.1rem] flex flex-col gap-3">
                    ...
                    <div class="flex items-start gap-[0.55rem] text-[0.77rem] text-slate-500 leading-relaxed px-3 py-[0.55rem] bg-[#0f1117] border border-[#1e2436] rounded-lg">
                        ...
                        Duplicate Expedition Description ID will be updated
                    </div>
...
<pre class="font-mono text-[0.78rem] leading-[1.8] text-slate-400 m-0 whitespace-pre"><span class="text-slate-600">{</span>
  <span class="text-blue-400">"expedition_code"</span><span class="text-slate-600">:</span> <span class="text-green-400">"02"</span><span class="text-slate-600">,</span>
  <span class="text-blue-400">"長距離練習航海"</span><span class="text-slate-600">:</span> <span class="text-green-400">"Sample"</span><span class="text-slate-600">,</span>
  <span class="text-blue-400">"外海まで足を延ばし"</span><span class="text-slate-600">:</span> <span class="text-green-400">"Sample"</span>
<span class="text-slate-600">}</span></pre>
        ...
        <form
            id="import-form"
            method="POST"
            action="{{ route('expedition-descs.import') }}"
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="bg-[#13161f] border border-[#1e2436] rounded-[0.85rem] overflow-hidden">
                    ...
                    <label class="flex items-start gap-[0.6rem] mx-[1.1rem] mb-[1.1rem] mt-3 px-[0.9rem] py-3 bg-orange-500/[0.06] border border-orange-500/20 rounded-[0.55rem] text-[0.78rem] text-slate-400 leading-relaxed cursor-pointer">
                        ...
                        <span>I understand that duplicate Expedition Description IDs will be <strong class="text-orange-500">overwritten</strong> during import.</span>
                    </label>
