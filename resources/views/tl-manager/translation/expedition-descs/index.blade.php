...
<div>
    <div class="flex items-end justify-between gap-4 mb-7 flex-wrap">
        <div>
            <h1 class="text-slate-100 tracking-tight leading-tight">Expedition Description List</h1>
            <p class="text-xs text-slate-500 mt-0.5">Manage and monitor ongoing translation expedition descriptions.</p>
        </div>

        <div class="flex gap-2 items-center">
            <a href="{{ route('expedition-descs.export') }}"
            ...
            <a href="{{ route('expedition-descs.create') }}"
