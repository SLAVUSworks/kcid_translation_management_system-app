...
@section('title', 'Create Item Translation')
    ...
    <div class="flex flex-col gap-6">
        <div class="flex items-end justify-between flex-wrap gap-4">
            <div>
                ...
                <h1 class="text-slate-100 tracking-tight leading-tight mt-1.5">Create Item Translation</h1>
            ...
            <div class="flex flex-col gap-4">
                <div class="bg-[#13161f] border border-[#1e2436] rounded-[0.85rem] overflow-hidden">
                    <div class="flex items-center gap-2 px-4 py-[0.7rem] border-b border-[#1e2436] bg-[#0f1117]">
                        ...
                        <span class="text-[0.78rem] font-bold text-slate-400 tracking-[0.04em]">Item Translation Details</span>
                    </div>

                    <div class="p-[1.1rem] flex flex-col gap-[0.9rem]">
                        <div>
                            <label class="block text-[0.7rem] font-bold tracking-[0.08em] uppercase text-slate-500 mb-[0.35rem]">Item ID</label>
                            <input
                                type="number"
                                name="item_id"
                                value="{{ old('item_id') }}"
                        ...
                        <div>
                            <label class="block text-[0.7rem] font-bold tracking-[0.08em] uppercase text-slate-500 mb-[0.35rem]">Item Code</label>
                            <input
                                type="text"
                                name="item_code"
                                value="{{ old('item_code') }}"
                                placeholder="_item_code_A1"
                ...
                <div class="bg-[#13161f] border border-[#1e2436] rounded-[0.85rem] p-4 flex flex-col gap-2">
                    <div class="flex items-start gap-2 text-[0.75rem] text-slate-600 leading-relaxed">
                        ...
                        Item ID controls ordering in exports
                    </div>
                    <div class="flex items-start gap-2 text-[0.75rem] text-slate-600 leading-relaxed">
                        <svg class="shrink-0 mt-[1px] text-slate-700" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"/>
                        ...
                        Item Code must be unique (e.g. _item_code_A1)
                    </div>
                    <div class="flex items-start gap-2 text-[0.75rem] text-slate-600 leading-relaxed">
                        <svg class="shrink-0 mt-[1px] text-slate-700" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"/>
