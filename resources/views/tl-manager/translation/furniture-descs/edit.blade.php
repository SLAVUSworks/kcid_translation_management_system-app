                ...
                <div class="bg-[#13161f] border border-[#1e2436] rounded-[0.85rem] overflow-hidden">
                    ...
                    <div class="p-[1.1rem]">
                        ...
                        <select
                            ...
                            <option
                                value="untranslated"
                                {{ old('status', $furnitureDesc->translationStatus?->status ?? 'untranslated') === 'untranslated' ? 'selected' : '' }}>
                                Untranslated
                            </option>
                            <option
                                value="on-progress"
                                {{ old('status', $furnitureDesc->translationStatus?->status ?? '') === 'on-progress' ? 'selected' : '' }}>
                                On Progress
                            </option>
                            <option
                                value="translated"
                                {{ old('status', $furnitureDesc->translationStatus?->status ?? '') === 'translated' ? 'selected' : '' }}>
                                Translated
                            </option>
                        </select>
                        @error('status')
